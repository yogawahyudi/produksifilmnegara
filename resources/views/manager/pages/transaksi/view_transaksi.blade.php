...
@section('title-page')
    <h1 class="mb-0 fw-bold">Detail Transaksi</h1> 
@endsection
...
@section('content')
    <div class="container-fluid">
       ...
       <div class="row mb-5 mt-5">
            <div class="col-12">
                <a href="{{route('index.manager.transaksi')}}" type="button" class="btn btn-link"><i class="bx bx-left-arrow-alt bx-md text-dark"></i></a>
            </div>
       </div>
