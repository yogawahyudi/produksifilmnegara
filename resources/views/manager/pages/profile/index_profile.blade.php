  ...
  background: #ecf0f5;
                ...
                @include('alert.alert')
                    <div class="row">
                        ...
                        <div class="col-8 mt-5 mb-5">
                            <form action="{{route('update.profile.manager', $user->id)}}" method="post">
                                <div class="row mb-3 me-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="" class="label-form">Nama</label>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <input type="text" value="{{old('name', $user->name)}}" class="form-control" name="nama">
                                    </div>
                                </div>
                                <div class="row mb-3 me-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="row mb-3 me-3">
                                 ...
                                 <div class="row mb-3 me-3">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <h6 class="text-muted">{{$user->jabatan}}</h6>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="updateImages" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-center">
            ...
            <form action="{{route('update.images.manager', $user->id)}}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal fade" id="changePassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-center">
            ...
            <form action="{{route('update.password.manager', $user->id)}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row mb-3 d-flex justify-content-center">
