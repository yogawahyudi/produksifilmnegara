                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                @if (Auth::guard('manager')->user()->img != null)
                                <img src="{{asset('/assets/images/profile/manager/'.Auth::guard('manager')->user()->img)}}" alt="user" class="rounded-circle" width="31" height="31">
                                @else
                                <img src="{{asset('/assets/images/profile/default-person.jpg')}}" alt="user" class="rounded-circle" width="31" height="31">                                    
                                @endif
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('index.profile.manager')}}"><i class="bx bx-user"></i>
                                    My Profile</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('manager.dashboard')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('index.dataPenyewa.manager')}}" aria-expanded="false"><i class='bx bx-user'></i><span class="hide-menu">Data Penyewa</span></a></li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('index.manager.transaksi')}}" aria-expanded="false"><i class="bx bx-spreadsheet"></i><span
