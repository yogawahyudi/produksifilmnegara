            ...
            <div class="card card-body">
                <div class="container-fluid mt-3 mb-3">
                  <div class="row mb-3">
                    ...
                    <h6>No Telephone : {{auth()->user()->no_hp}}</h6>
                  </div>
                  <hr>
                  <div class="row mb-3">
                    <div class="col-12">
                       <form action="{{route('store.transaksi.user', $studio->id)}}" method="post">
                        @csrf
                            <div class="row mb-3">
            ...
            <div class="card card-body">
                <div class="container-fluid mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h6 id="nama">{{Auth::user()->name}}</h6>
                            <h6 id="email">{{Auth::user()->email}}</h6>
                            <h6 id="no_tel">{{Auth::user()->no_hp}}</h6>
                            <h6 id="nama_per"></h6>
                            <h6 id="email_per"></h6>
                            <h6 id="no_tel_per"></h6>
                           <h6 id="shooting" > </h6>
                    ...
                    <div class="row mb-3">
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <button class="btn btn-danger" id="bayar">Bayar Sekarang</button>
                        </div>
                    </div>
                </div>
            </div>
