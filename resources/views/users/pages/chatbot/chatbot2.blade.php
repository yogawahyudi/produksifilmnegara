...
<div class="botIcon">
    <div class="botIconContainer">
        <div class="iconInner shadow">
            <i class="bx bx-bot" style="font-size: 2em"></i>
        </div>
    </div>
    <div class="Layout Layout-open Layout-expand expand Layout-right">
        <div class="Messenger_messenger">
            <div class="Messenger_header">                
                <span class="chat_close_icon"><i class="bx bx-exit"></i></span>
            </div>
...
<script>
	...
	$(document).on("submit", "#messenger", function(e) {
		...
		function userMsg(msg) {
            $("[name=msg]").val("");
			$('.Messages_list').append( '<div class="row mb-1 d-flex justify-content-end msg" id="userBuble" >' +
                    '<div class="col-10 d-flex justify-content-end">' +
                    '<div class="card style="width: auto">' +
                    '<div class="card-body">' +
                    '<p class="mb-0 mt-0" id="text" style="color: #aa1522">'+input+'</p>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>'
                    ...
                    success: (data) => {
                        ...
                        if(typeof data === 'object' && data !== null){
                            $('.Messages_list').append(
                                ...
                                '<div class="card" style="width: auto">' +
                                '<div class="card-body" style="background-color: #aa1522">' +
                                '<p id="text" style="background-color: #aa1522">' +data['respon']+ '</p>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>'
                                ...
                                '<div class="card" style="width: auto">' +
                                '<div class="card-body" style="background-color: #aa1522">' +
                                '<p id="text" style="background-color: #aa1522">' +data+ '</p>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>'
	...
	/* Chatboat Code */
         $('.Messages_list').append(
                ...
                '<div class="col-10  d-flex justify-content-start">' +
                '<div class="card" style="width: auto">' +
                '<div class="card-body rounded" style="background-color: #aa1522">' +
                '<p class="mb-0 mt-0 " id="text" style="color: #eee">Hallo selamat datang ada yang bisa dibantu</p>'  +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>'
   ...
   $('.Messages_list').append(
            '<div class="accordion accordion-flush mt-2 mb-2" id="accordionFlushExample">'+
                '<div class="accordion-item">'+
                    ...
                    '<div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">'+
                        '<ul class="list-group">'+
                            '<button class="list-group-item list-group-item-action sugesti">Harga studio 1</button>'+
                            '<button class="list-group-item list-group-item-action sugesti">Harga studio 2</button>'+   
                            '<button class="list-group-item list-group-item-action sugesti">Harga studio 3</button>'+
                            '<button class="list-group-item list-group-item-action sugesti">Harga studio 4</button>'+                        
                        '</ul>'+
                    '</div>'+
                '</div>'+
                '<div class="accordion-item">'+
                    ...
                    '<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">'+
                        '<ul class="list-group">'+
                            '<button class="list-group-item list-group-item-action sugesti ">Fasilitas studio 1</button>'+
                            '<button class="list-group-item list-group-item-action sugesti ">Fasilitas studio 2</button>'+   
                            '<button class="list-group-item list-group-item-action sugesti ">Fasilitas studio 3</button>'+
                            '<button class="list-group-item list-group-item-action sugesti ">Fasilitas studio 4</button>'+                      
                        '</ul>'+                    
                    '</div>'+
                '</div>'+
                '<div class="accordion-item">'+
                   '<ul class="list-group">'+
                        '<button class="list-group-item list-group-item-action sugesti">Apakah ada dp saat melakukan pemesanan ?</button>'+
                        '<button class="list-group-item list-group-item-action sugesti">Dimana lokasi pfn ?</button>'+                        
                    '</ul>'+
                '</div>'+
            '</div>'
   )
