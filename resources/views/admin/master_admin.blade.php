                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <img src="{{asset('/assets/images/profile/admin/'.Auth::guard('admin')->user()->img)}}" alt="user" class="rounded-circle" width="31" height="31">
                                @else
                                <img src="{{asset('/assets/images/profile/default-person.jpg')}}" alt="user" class="rounded-circle" width="31" height="31">                                    
                                @endif
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('index.profile.admin')}}"><i class="bx bx-user"></i>
                                    My Profile</a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('index.admin.assets')}}" aria-expanded="false"><i class='bx bx-user'></i><span class="hide-menu">Div Assets</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('index.admin.manager')}}" aria-expanded="false"><i class='bx bxs-user'></i> <span
                                    class="hide-menu">Div Manager</span></a></li>
                    </ul>
