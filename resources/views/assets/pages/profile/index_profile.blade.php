  ...
  background: #ecf0f5;
                        ...
                        <div class="col-4">
                            <div class="row mb-3 mb-5 mt-5">
                               <div class="col-12 text-center">
                                    @if ($user->img != null)
                                    <img src="{{asset('assets/images/profile/assets/'.$user->img)}}" class="rounded-circle border" alt="" srcset="" style="width :150px ;height:150px">
                                    @else                                        
                            ...
                            <div class="row">
                                <div class="d-grid gap-2 mx-auto col-6">
                                    <button class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#updateImages" >Ubah Foto Profile</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-8 mt-5 mb-5">
                            <form action="{{route('update.profile.assets' ,$user->id)}}" method="post">
                                @csrf
    ...
    <div class="modal fade" id="updateImages" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-center">
            ...
            <form action="{{route('update.images.assets', $user->id)}}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal fade" id="changePassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-center">
            ...
            <form action="{{route('update.password.assets', $user->id)}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row mb-3 d-flex justify-content-center">
